...
function Collapse({ title, text, largeur, fontS }) {
    const open = () => {
    ...
    return (
        <div className="colL" style={{ width: largeur}}>
            <button style={{ fontSize: fontS}} type="button" className="collapsible" onClick={open}>
            ...
            <div className="openCollapse" id={title}>
                {text}
            </div>
        </div>
    );
